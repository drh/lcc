...
reg: LSHI4(reg,rc5)  "?mov %c,%0\nsal %c,%1\n"  2
reg: LSHU4(reg,rc5)  "?mov %c,%0\nshl %c,%1\n"  2
reg: RSHI4(reg,rc5)  "?mov %c,%0\nsar %c,%1\n"  2
reg: RSHU4(reg,rc5)  "?mov %c,%0\nshr %c,%1\n"  2

stmt: ASGNI4(addr,LSHI4(mem,rc5))  "sal %1,%2\n"  memop(a)
stmt: ASGNI4(addr,LSHU4(mem,rc5))  "shl %1,%2\n"  memop(a)
stmt: ASGNI4(addr,RSHI4(mem,rc5))  "sar %1,%2\n"  memop(a)
stmt: ASGNI4(addr,RSHU4(mem,rc5))  "shr %1,%2\n"  memop(a)
