...
static void stabblock(int, int, Symbol*);
static void stabinit(char *, int, char *[]);
static void stabline(Coordinate *);
static void stabsym(Symbol);
static void stabtype(Symbol);
...
static void stabinit(char *file, int argc, char *argv[]) {
        ...
        if (file && *file) {
                ...
                if (cwd)
                        print(".stabs \"%s/\",0x%x,0,3,.LLtext0\n", cwd, N_SO);
                print(".stabs \"%s\",0x%x,0,3,.LLtext0\n", file, N_SO);
                (*IR->segment)(CODE);
                print(".LLtext0:\n", file, N_SO);
                currentfile = file;
...
static char rcsid[] = "$Id: sparc.nw,v 2.23 1997/06/09 17:51:33 drh Exp $";
